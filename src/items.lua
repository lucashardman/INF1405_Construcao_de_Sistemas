...
local function generateItem()
	...
	for count = 1, 3 do
		...
		pocaoVerdeGrande.myType = "potion"
	...
	for count = 1, 3 do
		...
		pocaoVerdePequena.myType = "potion"
	...
	for count = 1, 3 do
		...
		pocaoRosaExtendida.myType = "potion"
	...
	for count = 1, 3 do
		...
		pocaoAzulPequena.myType = "potion"
